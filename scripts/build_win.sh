...
# Python dependencies
pacman -S --needed --noconfirm base-devel mingw-w64-x86_64-toolchain mingw-w64-x86_64-zlib mingw-w64-x86_64-openssl mingw-w64-x86_64-libffi mingw-w64-x86_64-bzip2 mingw-w64-x86_64-winpthreads
